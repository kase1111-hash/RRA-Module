...
class TestAssetTokenizer:
    ...
    def test_full_tokenization_workflow(self, tokenizer: AssetTokenizer):
        ...
        tokenizer.add_document(
            request.request_id, "registration_certificate", "QmCertHash", "Copyright registration"
        )
        tokenizer.add_document(
            request.request_id, "proof_of_ownership", "QmOwnerHash", "Proof of authorship"
        )
        tokenizer.add_document(
            request.request_id, "source_description", "QmSourceHash", "Source code description"
        )
        ...
        # Tokenize
        asset = tokenizer.tokenize(request.request_id, token_uri="ipfs://QmTokenMetadata")
    ...
    def test_update_valuation(self, tokenizer: AssetTokenizer):
        ...
        asset = tokenizer.update_valuation(
            token_id=asset.token_id, valuation=Decimal("75000"), confidence=8500
        )
...
class TestRWACompliance:
    ...
    def test_register_participant(self, checker: RWAComplianceChecker):
        ...
        profile = checker.register_participant(address="0xParticipant", jurisdictions=["US"])
    ...
    def test_update_kyc_status(self, checker: RWAComplianceChecker):
        ...
        profile = checker.update_kyc_status(
            address="0xUser", status=KYCStatus.VERIFIED, provider="Jumio", expires_in_days=365
        )
    ...
    def test_update_accreditation(self, checker: RWAComplianceChecker):
        ...
        profile = checker.update_accreditation(
            address="0xInvestor", accreditation_type=AccreditationType.ACCREDITED_INDIVIDUAL
        )
    ...
    def test_pep_status(self, checker: RWAComplianceChecker):
        ...
        report = checker.check_participant_eligibility(
            address="0xPolitician", jurisdiction="US", asset_type="patent_utility"
        )
...
class TestValuationOracle:
    ...
    def test_income_valuation(self, oracle: ValuationOracle):
        ...
        result = oracle.calculate_valuation(
            asset_id="test_asset", inputs=inputs, method=ValuationMethod.INCOME_APPROACH
        )
    ...
    def test_market_comparable_valuation(self, oracle: ValuationOracle):
        ...
        result = oracle.calculate_valuation(
            asset_id="test_asset", inputs=inputs, method=ValuationMethod.MARKET_COMPARABLE
        )
    ...
    def test_cost_valuation(self, oracle: ValuationOracle):
        ...
        result = oracle.calculate_valuation(
            asset_id="software_asset", inputs=inputs, method=ValuationMethod.COST_APPROACH
        )
    ...
    def test_royalty_relief_valuation(self, oracle: ValuationOracle):
        ...
        result = oracle.calculate_valuation(
            asset_id="patent_asset", inputs=inputs, method=ValuationMethod.ROYALTY_RELIEF
        )
...
class TestValuationAggregator:
    ...
    def test_consensus_valuation(self, aggregator: ValuationOracleAggregator):
        ...
        consensus = aggregator.request_valuation(
            asset_id="consensus_test", inputs=inputs, methods=[ValuationMethod.INCOME_APPROACH]
        )
...
class TestLegalWrapperGenerator:
    ...
    def test_list_templates(self, generator: LegalWrapperGenerator):
        ...
        # Filter by type
        assignment_templates = generator.list_templates(
    ...
    def test_sign_wrapper(self, generator: LegalWrapperGenerator):
        ...
        party1 = LegalParty(
            name="Party One", legal_type="individual", jurisdiction="US", wallet_address="0xParty1"
        )
        party2 = LegalParty(
            name="Party Two", legal_type="individual", jurisdiction="US", wallet_address="0xParty2"
        )
        ...
        wrapper = generator.sign_wrapper(
            wrapper_id=wrapper.wrapper_id, party_wallet="0xParty1", signature="0xSignature1"
        )
        assert wrapper.status == "partially_signed"

        # Second signature
        wrapper = generator.sign_wrapper(
            wrapper_id=wrapper.wrapper_id, party_wallet="0xParty2", signature="0xSignature2"
        )
    ...
    def test_store_on_ipfs(self, generator: LegalWrapperGenerator):
        ...
        wrapper = generator.store_on_ipfs(
            wrapper_id=wrapper.wrapper_id, ipfs_hash="QmTestIPFSHash123456789"
        )
    ...
    def test_export_to_json(self, generator: LegalWrapperGenerator):
        ...
        party1 = LegalParty(
            name="Exporter", legal_type="corp", jurisdiction="US", wallet_address="0xExp"
        )
        party2 = LegalParty(
            name="Importer", legal_type="corp", jurisdiction="EU", wallet_address="0xImp"
        )
    ...
    def test_get_wrappers_for_asset(self, generator: LegalWrapperGenerator):
        ...
        party1 = LegalParty(
            name="Owner", legal_type="individual", jurisdiction="US", wallet_address="0xOwn"
        )
        party2 = LegalParty(
            name="Buyer", legal_type="individual", jurisdiction="US", wallet_address="0xBuy"
        )
...
class TestRWAIntegration:
    ...
    def test_full_rwa_workflow(self):
        ...
        tokenizer.add_document(
            request.request_id, "registration_certificate", "QmCert", "USPTO Certificate"
        )
        tokenizer.add_document(
            request.request_id, "proof_of_ownership", "QmOwner", "Assignment chain"
        )
