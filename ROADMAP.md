...
1. Repo owner deploys Negotiator Agent
2. Buyer experiences:
   - Instant negotiation
   - Zero email
   - On-chain settlement
...
4. Buyer deploys RRA for their repos
5. Each repo embeds / links its agent
6. Network grows without marketing
...
That's exactly what the 4-tier access strategy accomplishes.
...
### 1. Marketplace + Deep Links (Lowest Effort, High Leverage)

**Priority:** Ship first

#### What This Is

A NatLangChain Discovery Dashboard. Think:
...
- Lets RRA live inside:
  ...
  - Docs
  - Landing pages
- Webhooks are proven infrastructure glue -- low risk, high adoption
...
> This is where RRA stops being "a network you join" and becomes infrastructure you embed.

---

### 3. Progressive / Hybrid Access (Smooths Adoption Curve)

Not everyone is crypto-native.
...
### 4. Auto-Apply Fixes with Validation Gates
...
### 5. Trial Software Licensing with Sundown Enforcement
...
**3. Sundown Code Injection**

Four enforcement approaches, each with increasing strength:
...
### Embeddable Negotiation Widget (The Endgame)

This is where the system becomes unavoidable.
...
### Evolutionary Learning Loop via On-Chain Feedback
