...
class JurisdictionRules:
    ...
    # Requirements
    tax: TaxRequirements = field(default_factory=lambda: TaxRequirements(
...
class JurisdictionRulesRegistry:
    ...
    def _initialize_default_rules(self):
        ...
        self._rules[JurisdictionCode.US] = JurisdictionRules(
            ...
            tax=TaxRequirements(
                ...
                treaty_countries=[
                    JurisdictionCode.GB, JurisdictionCode.DE, JurisdictionCode.FR,
                    JurisdictionCode.JP, JurisdictionCode.CA, JurisdictionCode.AU,
                ],
        ...
        self._rules[JurisdictionCode.GB] = JurisdictionRules(
            ...
            tax=TaxRequirements(
                ...
                has_treaty_network=True,
                treaty_countries=[
                    JurisdictionCode.US, JurisdictionCode.DE, JurisdictionCode.FR,
                ],
                vat_applicable=True,
    ...
    def get_compatible_rules(
        ...
        merged = {
            ...
            "prospectus_required": rules1.disclosure.prospectus_required or rules2.disclosure.prospectus_required,
            "risk_disclosure_required": rules1.disclosure.risk_disclosure_required or rules2.disclosure.risk_disclosure_required,
            
            # Take more restrictive investor requirements
            "accreditation_required": rules1.investor.accreditation_required or rules2.investor.accreditation_required,
            "holding_period_days": max(
                rules1.investor.holding_period_days,
                rules2.investor.holding_period_days
            ),
            "cooling_off_period_days": max(
                rules1.investor.cooling_off_period_days,
                rules2.investor.cooling_off_period_days
            ),
            ...
            "arbitration_seat": "London" if (
                jurisdiction1 != JurisdictionCode.GB and 
                jurisdiction2 != JurisdictionCode.GB
            ) else "Singapore",
    ...
    def check_transaction_compliance(
        ...
        return {
            ...
            "from_rules_summary": {
                ...
                "withholding_rate": str(from_rules.tax.withholding_rate) if from_rules else None,
            } if from_rules else None,
            "to_rules_summary": {
                "jurisdiction": to_jurisdiction.value,
                "accreditation_required": to_rules.investor.accreditation_required if to_rules else None,
                "prospectus_required": to_rules.disclosure.prospectus_required if to_rules else None,
            } if to_rules else None,
        }
